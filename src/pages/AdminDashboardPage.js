...
const AdminDashboardPage = () => {
    ...
    const handleOpenEditDialog = (service) => {
        ...
        setFormData({
            ...
            endDate: service.endDate ? dayjs(service.endDate) : null,
            endTime: service.endTime ? dayjs(service.endTime, 'HH:mm') : null
        });
            ...
            <Box sx={{
                ...
                <Dialog open={inquiryDialogOpen} onClose={() => setInquiryDialogOpen(false)} maxWidth="md" fullWidth
                    ...
                    <DialogContent>
                        {selectedInquiry && (
                            <Box sx={{ mt: 2 }}>
                                <Paper sx={{ p: 2.5, mb: 3, bgcolor: alpha('#FF9800', 0.1), borderRadius: '16px' }}>
                                    <Grid container spacing={2}>
                                        <Grid item xs={6}>
                                            <Typography variant="caption" sx={{ color: alpha('#FFFFFF', 0.5) }}>Customer</Typography>
                                            <Typography variant="body2" sx={{ color: '#FFFFFF' }}>{selectedInquiry.user?.userName}</Typography>
                                        </Grid>
                                        <Grid item xs={6}>
                                        ...
                                        <Grid item xs={12}>
                                            ...
                                            <Typography variant="body2" sx={{ color: alpha('#FFFFFF', 0.9) }}>{selectedInquiry.message}</Typography>
                                        </Grid>
                                    </Grid>
                                </Paper>
                                <TextField
